...
from .models import NewsEntry, LinkEntry, Product, TableDefinition
...
def products(request):
        ...
        for sn in range(len(sheet_names)):
            dfs = pandas.read_excel('SMA.xlsx', sheet_name=sheet_names[sn], engine='openpyxl')
